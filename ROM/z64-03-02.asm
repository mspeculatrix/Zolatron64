...
; This version is nearly working.
;   - It prints to the LCD
;   - It sends output OK via serial.
;   - It accepts input from serial, but only the first char is okay. Subsequent
;     chars are corrupted. This is an overrun problem.
;
; This version:
