...
CMD_TKN_CHAIN  = CMD_TKN_BRK + 1       ; CHAIN - load and run executable
CMD_TKN_CLEAR  = CMD_TKN_CHAIN + 1     ; CLEAR - clear program
CMD_TKN_DATE   = CMD_TKN_CLEAR + 1     ; DATE - print current date
CMD_TKN_DEL    = CMD_TKN_DATE + 1      ; DEL - delete file
CMD_TKN_DUMP   = CMD_TKN_DEL + 1       ; DUMP - save memory to storage
CMD_TKN_HELP   = CMD_TKN_DUMP + 1      ; HELP - display command list
...
CMD_TKN_OPEN   = CMD_TKN_MV + 1        ; OPEN - load file into memory
CMD_TKN_PDUMP  = CMD_TKN_OPEN + 1      ; PDUMP - program dump
CMD_TKN_PEEK   = CMD_TKN_PDUMP + 1     ; PEEK - view a single byte in memory
CMD_TKN_POKE   = CMD_TKN_PEEK + 1      ; POKE - set a single byte in memory
CMD_TKN_PRT    = CMD_TKN_POKE + 1      ; PRT (under construction)
CMD_TKN_RUN    = CMD_TKN_PRT + 1       ; RUN - run user program
CMD_TKN_SAVE   = CMD_TKN_RUN + 1       ; SAVE - save part of memory to store
CMD_TKN_STAT   = CMD_TKN_SAVE + 1      ; STAT - show system stats
CMD_TKN_TIME   = CMD_TKN_STAT + 1
CMD_TKN_VERS   = CMD_TKN_TIME + 1      ; VERS - show version
