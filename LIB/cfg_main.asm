...
FREAD_ERR_CODE        = SYNTAX_ERR_CODE + 1				  ; 7  File read error
FREAD_TO_SR			      = FREAD_ERR_CODE + 1		      ; 8  SR Timeout
...
FILE_LIST_ERR         = FREAD_SVR_OPEN + 1          ; 13 C  LS error
FN_CHAR_ERR_CODE      = FILE_LIST_ERR + 1           ; 14 D  Bad character
...
ERR_DELFILE_FAIL      = ERR_FILE_OPEN + 1           ; 24 17 Failed delete file
ERR_FILENOTFOUND      = ERR_DELFILE_FAIL + 1        ; 25 18 File not found
