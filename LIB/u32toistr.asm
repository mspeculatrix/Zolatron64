...
; MATH_TMP16    =_zpage_              ;string storage pointer
;
;	---------------------------------
...
;	---------------------------------
;
pfac      MATH_TMP16+s_ptr          ;primary accumulator
...
STRBUF_IDX   =radix+1              ;string buffer index
;
;================================================================================
;
...
; assume number is in MATH_TMP16/+1

;
binstr   stx MATH_TMP16             ;operand pointer LSB
         sty MATH_TMP16+1           ;operand pointer MSB
         tax                   ;protect radix
         ldy #s_pfac-1         ;operand size
;
binstr01 lda MATH_TMP16),y         ;copy operand to...
         sta pfac,y            ;workspace
         dey
         bpl binstr01
;
         iny
         sty STRBUF_IDX            ;initialize string index
;
;
;	------------------------------
...
binstr14 adc #'0'              ;change to ASCII
         ldy STRBUF_IDX            ;string index
         sta strbuf,y          ;save numeral in buffer
         inc STRBUF_IDX            ;next buffer position
...
;
         lda #0
         ldx STRBUF_IDX            ;printable string length
